...
This program adapts the one found in the ostep homeworks. The purpose is to
plot to show what fraction of randomly-generatzed virtual addresses are valid,
as a function of the value of the bounds register.
